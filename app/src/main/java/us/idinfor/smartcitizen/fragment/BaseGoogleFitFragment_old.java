...
public abstract class BaseGoogleFitFragment_old extends Fragment implements GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener,  ResultCallback<DataReadResult> {

    private static final String TAG = BaseGoogleFitFragment_old.class.getCanonicalName();
