...
public class ActivitySegmentAdapter extends RecyclerView.Adapter<ActivitySegmentAdapter.ViewHolder> implements View.OnClickListener {
    ...
    private List<ActivitySegment> mActivities;

    public ActivitySegmentAdapter(List<ActivitySegment> activities) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ActivitySegment activitySegment = mActivities.get(position);
    ...
    public void addAll(List<ActivitySegment> activities){
